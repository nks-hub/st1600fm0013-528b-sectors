...
The backups in this directory are irreplaceable for this particular card, because the
...
survives. `-e 7` erases that too, so the address has to be restored by hand.
