...
**Stav: 512 B vyřešeno, dvěma cestami.**

1. **Reformát.** Disky bez Seagate zámku přijmou `sg_format --size=512` rovnou:
   žádná ztráta kapacity, standardní kernel, plná nativní rychlost. Ověřeno na
   HGST kusu, viz [`reformat-528-512_CZ.md`](reformat-528-512_CZ.md). **Tohle
   zkoušej první** – nedestruktivní sonda ti ve zlomku vteřiny řekne, jestli to
   půjde.
